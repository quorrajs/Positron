...
App.prototype.register = function (provider, force, callback) {
    ...
    if(!(providerInstance instanceof ServiceProvider)) {
        throw 'Provider: '+ provider + ' is not an instance of ServiceProvider class';
    }
...
App.prototype.boot = function(callback) {
    ...
    Object.keys(this.__loadedProviders).forEach(function (providerKey) {
...
App.prototype.listen = function (callback) {
    ...
    if (!!~portOptionIndex) {
        ...
        port = this.config.get('app').port || 3000;
    }
    ...
    server.listen(port, function () {
        ...
        console.log(('\r\nQuorra server listening on port ' + port).green);
