...
var urlGeneratorInstance;
var UrlGenereator = require('../routing/UrlGenerator');;
...
req.__defineGetter__('routeParameters', function()
{
    if (isset(this.params))
    {
        Object.keys(this.params).map(function(value){
            if(str.isString(this.params['value'])) {
...
req.__defineGetter__('protocol', function(){
  var trustProxy = this.app.config.get('app').trustProxy;
 ...
 * @return {String}
 */
//@todo: note '/' is not stripped from path
...
req.__defineGetter__('urlGenerator', function(){
    if(!urlGeneratorInstance) {
       urlGeneratorInstance = new UrlGenereator(this.app.router.getRoutes(), this);
    }
    return urlGeneratorInstance;
});