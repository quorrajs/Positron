 ...
 *
 * @todo: works needed to be done with all methods
 */
...
req.__defineGetter__('protocol', function(){
  var trustProxy = false/*this.app.get('trust proxy')*/;
...
/**
 * Get a given parameter for the route.
 *
 * @param  {string}  name
 * @param  {*}  defaultValue
 * @return string
