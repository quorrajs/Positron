...
Router.getControllerInstance = function(path, arguments) {
    if(isset(this.__controllerInstances[path])) {
        return this.__controllerInstances[path];
    } else {
        return this.__controllerInstances[path] = new (Function.prototype.bind.apply(path, [null].concat(arguments)));
    }
};
